        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholderTextColor="#999"
            />
            {errors.streetAddress && <ThemedText style={styles.errorText}>{errors.streetAddress}</ThemedText>}
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={[styles.pickerContainer, errors.stateOrTerritory && styles.inputError]}>
              <Picker
                selectedValue={formData.stateOrTerritory}
                onValueChange={(value) => updateField('stateOrTerritory', value)}
                style={styles.picker}>
            ...
            {errors.stateOrTerritory && <ThemedText style={styles.errorText}>{errors.stateOrTerritory}</ThemedText>}
          </View>
          ...
          <View style={styles.inputGroup}>
            ...
            />
            {errors.postalCode && <ThemedText style={styles.errorText}>{errors.postalCode}</ThemedText>}
          </View>
